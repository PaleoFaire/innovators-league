...
const MASTER_COMPANY_LIST = [
  ...
  { name: "Safe Superintelligence", aliases: ["SSI", "Safe Superintelligence Inc", "Ilya Sutskever"], sector: "ai", ticker: null },
  { name: "Thinking Machines Lab", aliases: ["ThinkingMachines", "Mira Murati"], sector: "ai", ticker: null },
  { name: "World Labs", aliases: ["WorldLabs", "Fei-Fei Li", "Marble"], sector: "ai", ticker: null },
  { name: "Luma AI", aliases: ["LumaAI", "Dream Machine", "Ray3"], sector: "ai", ticker: null },
  { name: "Magic AI", aliases: ["MagicDev", "Magic.dev"], sector: "ai", ticker: null },
  { name: "Liquid AI", aliases: ["LiquidAI", "Liquid foundation model"], sector: "ai", ticker: null },
  { name: "SambaNova Systems", aliases: ["SambaNova", "RDU"], sector: "chips", ticker: null },
  { name: "Credo Semiconductor", aliases: ["Credo Technology", "CRDO"], sector: "chips", ticker: "CRDO" },
  { name: "Polar Semiconductor", aliases: ["PolarSemi"], sector: "chips", ticker: null },
  { name: "Lightelligence", aliases: ["Hummingbird photonic"], sector: "chips", ticker: null },
  { name: "DZYNE Technologies", aliases: ["DZYNE"], sector: "defense", ticker: null },
  { name: "Scout AI", aliases: ["ScoutAI", "Fury VLA"], sector: "defense", ticker: null },
  { name: "SiFly", aliases: ["Si Fly", "Q12 drone", "Q250"], sector: "defense", ticker: null },
  { name: "Hyfix", aliases: ["Hyfix silicon", "drone GPS chip"], sector: "defense", ticker: null },
  { name: "Red 6", aliases: ["Red6", "ATARS"], sector: "defense", ticker: null },
  { name: "Portal Space Systems", aliases: ["PortalSpace", "Supernova spacecraft"], sector: "space", ticker: null },
  { name: "Sift", aliases: ["SiftStack", "Sift Stack"], sector: "space", ticker: null },
  { name: "Stratolaunch", aliases: ["Talon-A2", "Roc"], sector: "space", ticker: null },
  { name: "Scout Space", aliases: ["ScoutSpace", "Space Safari"], sector: "space", ticker: null },
  { name: "Persona AI", aliases: ["PersonaAI", "shipyard humanoid"], sector: "robotics", ticker: null },
  { name: "Reflex Robotics", aliases: ["ReflexRobotics"], sector: "robotics", ticker: null },
  { name: "Nimble Robotics", aliases: ["NimbleRobotics"], sector: "robotics", ticker: null },
  { name: "Sunday Robotics", aliases: ["SundayRobotics"], sector: "robotics", ticker: null },
  { name: "Bear Robotics", aliases: ["BearRobotics", "Servi"], sector: "robotics", ticker: null },
  { name: "Pivotal", aliases: ["Pivotal eVTOL", "Helix eVTOL"], sector: "transportation", ticker: null },
  { name: "Alef Aeronautics", aliases: ["Alef flying car"], sector: "transportation", ticker: null },
  { name: "Tomorrow.io", aliases: ["Tomorrow weather"], sector: "space", ticker: null },
  { name: "Sofar Ocean", aliases: ["SofarOcean", "Spotter buoy"], sector: "ocean", ticker: null },
  { name: "Ocean Infinity", aliases: ["OceanInfinity", "Armada USV"], sector: "ocean", ticker: null },
  { name: "ICON", aliases: ["ICON 3D", "Project Olympus"], sector: "housing", ticker: null },
  { name: "Brilliant Labs", aliases: ["BrilliantLabs", "Frame AR"], sector: "consumer", ticker: null },
  { name: "Xaira Therapeutics", aliases: ["Xaira", "Tessier-Lavigne"], sector: "biotech", ticker: null },
  { name: "EvolutionaryScale", aliases: ["ESM3", "protein language model"], sector: "biotech", ticker: null },
  { name: "Formation Bio", aliases: ["FormationBio"], sector: "biotech", ticker: null },
  { name: "Genesis Therapeutics", aliases: ["GEMS platform"], sector: "biotech", ticker: null },
  { name: "Nabla Bio", aliases: ["NablaBio", "JAM antibody"], sector: "biotech", ticker: null },
  { name: "Iambic Therapeutics", aliases: ["Iambic", "IAM1363"], sector: "biotech", ticker: null },
  { name: "Chroma Medicine", aliases: ["ChromaMedicine", "epigenome editing"], sector: "biotech", ticker: null },
  { name: "Rondo Energy", aliases: ["RondoEnergy", "thermal battery"], sector: "energy", ticker: null },
  { name: "Thea Energy", aliases: ["TheaEnergy", "planar coil stellarator"], sector: "nuclear", ticker: null },
  { name: "Sila Nanotechnologies", aliases: ["SilaNano", "Titan Silicon"], sector: "battery", ticker: null },
  { name: "Realta Fusion", aliases: ["RealtaFusion", "mirror fusion"], sector: "nuclear", ticker: null },
  { name: "Mitra Chem", aliases: ["MitraChem", "AI cathode"], sector: "battery", ticker: null },
  { name: "Curio Solutions", aliases: ["CurioSolutions", "NuCycle", "HALEU"], sector: "nuclear", ticker: null },
  { name: "Nuclearn.ai", aliases: ["Nuclearn AI"], sector: "nuclear", ticker: null },
  { name: "Emerald AI", aliases: ["EmeraldAI", "data center grid"], sector: "energy", ticker: null },
  { name: "Elementl Power", aliases: ["Elementl", "Google nuclear deal"], sector: "nuclear", ticker: null },
];
