...
// Last updated: 2026-02-13 21:54
const COMPANY_SIGNALS = [
  { id: 1, type: "news", company: "OpenAI", headline: "Why top talent is walking away from OpenAI and xAI", source: "TechCrunch", time: "Just now", impact: "low", unread: true },
  { id: 2, type: "funding", company: "Anthropic", headline: "The Week's 10 Biggest Funding Rounds: Anthropic Leads In A Big Week For Giant Rounds", source: "Crunchbase News", time: "2h ago", impact: "high", unread: true },
  { id: 3, type: "news", company: "OpenAI", headline: "OpenAI removes access to sycophancy-prone GPT-4o model", source: "TechCrunch", time: "3h ago", impact: "low", unread: true },
  { id: 4, type: "news", company: "Anthropic", headline: "Anthropic's Super Bowl ads mocking AI with ads helped push Claude's app into the top 10", source: "TechCrunch", time: "4h ago", impact: "low", unread: true },
  { id: 5, type: "ipo", company: "OpenAI", headline: "Cohere's $240M year sets stage for IPO", source: "TechCrunch", time: "6h ago", impact: "high", unread: true },
  { id: 6, type: "news", company: "Waymo", headline: "Waymo is asking DoorDash drivers to shut the doors of its self-driving cars", source: "TechCrunch", time: "17h ago", impact: "low", unread: false },
  { id: 7, type: "news", company: "OpenAI", headline: "OpenAI sidesteps Nvidia with unusually fast coding model on plate-sized chips", source: "Ars Technica", time: "22h ago", impact: "low", unread: false },
  { id: 8, type: "news", company: "Palantir", headline: "'Uncanny Valley': ICE's Secret Expansion Plans, Palantir Workers' Ethical Concerns, and AI Assistants", source: "Wired", time: "23h ago", impact: "medium", unread: false },
  { id: 9, type: "funding", company: "Axiom Space", headline: "Axiom Space raises additional $350 million", source: "SpaceNews", time: "1d ago", impact: "medium", unread: false },
  { id: 10, type: "funding", company: "Anthropic", headline: "Anthropic Raises $30B At $380B Valuation In Second-Largest Venture Funding Deal Of All Time", source: "Crunchbase News", time: "1d ago", impact: "high", unread: false },
  { id: 11, type: "ipo", company: "Waymo", headline: "Waymo Asks the DC Public to Pressure Their City Officials", source: "Wired", time: "1d ago", impact: "low", unread: false },
  { id: 12, type: "news", company: "OpenAI", headline: "OpenAI's President Gave Millions to Trump. He Says It's for Humanity", source: "Wired", time: "1d ago", impact: "medium", unread: false },
  { id: 13, type: "ipo", company: "SpaceX", headline: "Launch companies debate how to compete against SpaceX", source: "SpaceNews", time: "1d ago", impact: "low", unread: false },
  { id: 14, type: "ipo", company: "SpaceX", headline: "SpaceX takes down Dragon crew arm, giving Starship a leg up in Florida", source: "Ars Technica Space", time: "1d ago", impact: "low", unread: false },
  { id: 15, type: "ipo", company: "SpaceX", headline: "SpaceX IPO may suck oxygen from market before unleashing broad capital surge", source: "SpaceNews", time: "1d ago", impact: "high", unread: false },
];
