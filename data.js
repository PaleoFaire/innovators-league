...
const COMPANIES = [
  ...
  // DEFENSE & AEROSPACE
  {
    ...
    sector: "Defense & Security",
    description: "Building next-generation unmanned defense systems and autonomous weapons platforms for modern warfare applications.",
    founder: "",
    location: "Los Angeles, CA",
    state: "CA",
    lat: 34.0522,
    ...
    totalRaised: "$25M+",
    valuation: "",
    tags: ["defense", "autonomous systems", "robotics"],
    signal: "rising",
    scores: { team: 7, traction: 6, techMoat: 7, market: 9, momentum: 7 },
    competitors: ["Anduril", "Shield AI"],
    addedDate: "2026-02"
  },
  {
    name: "Mach Industries",
    sector: "Defense & Security",
    description: "Hardware defense technology company developing hydrogen-powered UAVs and hypersonic systems for military applications.",
    founder: "",
    location: "Huntington Beach, CA",
    state: "CA",
    lat: 33.6595,
    ...
    totalRaised: "$80M+",
    valuation: "",
    tags: ["defense", "hydrogen", "UAV", "hypersonic"],
    signal: "rising",
    scores: { team: 8, traction: 7, techMoat: 8, market: 9, momentum: 8 },
    competitors: ["Hermeus", "Venus Aerospace"],
    addedDate: "2026-02"
  },
  {
    name: "Kela",
  ...
  },
  {
    name: "Nominal",
    sector: "Space & Aerospace",
    description: "Software platform for space, energy, and defense technology companies to manage complex hardware operations.",
    founder: "",
    location: "San Francisco, CA",
    state: "CA",
    lat: 37.7749,
    ...
    totalRaised: "$25M+",
    valuation: "",
    tags: ["software", "space", "defense", "operations"],
    signal: "rising",
    scores: { team: 7, traction: 6, techMoat: 7, market: 8, momentum: 7 },
    competitors: ["Palantir", "Slingshot Aerospace"],
    addedDate: "2026-02"
  },
  {
    name: "Endurosat",
  ...
  },
  {
    name: "Bright Machines",
    sector: "Robotics & Manufacturing",
    description: "Software-defined manufacturing platform combining AI, robotics, and machine learning for flexible production lines.",
    ...
    totalRaised: "$400M+",
    valuation: "",
    tags: ["manufacturing", "AI", "robotics", "automation"],
    signal: "stable",
    scores: { team: 8, traction: 7, techMoat: 8, market: 9, momentum: 7 },
    competitors: ["Veo Robotics", "Rapid Robotics"],
    addedDate: "2026-02"
  },
  {
    name: "Covariant",
    sector: "Robotics & Manufacturing",
    description: "Building universal AI for robotic manipulation, enabling robots to pick and handle diverse objects in warehouses.",
    founder: "Pieter Abbeel, Peter Chen, Rocky Duan, Tianhao Zhang",
    location: "Emeryville, CA",
    state: "CA",
    lat: 37.8313,
    ...
    totalRaised: "$220M+",
    valuation: "$625M+",
    tags: ["AI", "robotics", "warehouse", "manipulation"],
    signal: "rising",
    scores: { team: 9, traction: 7, techMoat: 9, market: 9, momentum: 8 },
    competitors: ["Dexterity", "Nimble Robotics"],
    addedDate: "2026-02"
  },
  {
    name: "Vayu Robotics",
  ...
  },
  {
    name: "Zipline",
    sector: "Robotics & Manufacturing",
    description: "World's largest drone delivery network, delivering medical supplies and consumer products across multiple countries.",
    ...
    totalRaised: "$700M+",
    valuation: "$4B+",
    tags: ["drones", "delivery", "logistics", "healthcare"],
    signal: "hot",
    scores: { team: 9, traction: 9, techMoat: 9, market: 9, momentum: 9 },
    competitors: ["Wing", "Amazon Prime Air"],
    addedDate: "2026-02"
  },
  ...
  },
  {
    name: "Sublime Systems",
    sector: "Climate & Energy",
    description: "Electrochemical process for producing zero-carbon cement at scale, eliminating fossil fuels from cement production.",
    founder: "Leah Ellis, Yet-Ming Chiang",
    location: "Somerville, MA",
    state: "MA",
    lat: 42.3876,
    ...
    totalRaised: "$100M+",
    valuation: "",
    tags: ["cement", "decarbonization", "climate"],
    signal: "rising",
    scores: { team: 9, traction: 7, techMoat: 9, market: 9, momentum: 8 },
    competitors: ["Fortera", "CarbonCure"],
    addedDate: "2026-02"
  },
  {
    name: "LanzaTech",
  ...
  },
  {
    name: "Twelve",
    sector: "Climate & Energy",
    description: "CO2 recycling technology converting captured carbon dioxide into valuable chemicals and fuels using electrochemistry.",
    founder: "Nicholas Flanders, Etosha Cave, Kendra Kuhl",
    location: "Berkeley, CA",
    state: "CA",
    lat: 37.8715,
    ...
    totalRaised: "$200M+",
    valuation: "",
    tags: ["CO2", "recycling", "fuels", "chemicals"],
    signal: "rising",
    scores: { team: 8, traction: 7, techMoat: 8, market: 9, momentum: 8 },
    competitors: ["LanzaTech", "Opus 12"],
    addedDate: "2026-02"
  },
  {
  ...
  // AI & QUANTUM
  {
    name: "PsiQuantum",
    sector: "Quantum Computing",
    description: "Building the world's first utility-scale photonic quantum computer using silicon photonics technology.",
    founder: "Jeremy O'Brien, Terry Rudolph, Pete Shadbolt, Mark Thompson",
    location: "Palo Alto, CA",
    state: "CA",
    lat: 37.4419,
    lng: -122.1430,
    ...
    totalRaised: "$700M+",
    valuation: "$3.1B",
    tags: ["quantum", "photonics", "computing"],
    signal: "rising",
    scores: { team: 9, traction: 7, techMoat: 9, market: 9, momentum: 8 },
  ...
  },
  {
    name: "Atom Computing",
    sector: "Quantum Computing",
    description: "Building quantum computers using individually controlled neutral atoms in optical arrays.",
    founder: "Ben Bloom, Jonathan King",
    location: "Boulder, CO",
    state: "CO",
    lat: 40.0150,
    ...
    totalRaised: "$80M+",
    valuation: "",
    tags: ["quantum", "neutral atoms", "computing"],
    signal: "rising",
    scores: { team: 8, traction: 7, techMoat: 8, market: 9, momentum: 8 },
    competitors: ["IonQ", "Rigetti", "QuEra"],
    addedDate: "2026-02"
  },
  {
    name: "Sakana AI",
  ...
  // BIOTECH & HEALTH
  {
    name: "Eikon Therapeutics",
    sector: "Biotech & Health",
    description: "Drug discovery platform using super-resolution microscopy to observe protein movements in living cells.",
    founder: "Roger Bhalla, Eric Bhella, Travis Westly",
    location: "Hayward, CA",
    state: "CA",
    lat: 37.6688,
    lng: -122.0808,
    ...
    totalRaised: "$700M+",
    valuation: "$3.3B",
    tags: ["drug discovery", "microscopy", "biotech"],
    signal: "rising",
    scores: { team: 9, traction: 7, techMoat: 9, market: 9, momentum: 8 },
    competitors: ["Recursion", "Insitro"],
    addedDate: "2026-02"
  },
  {
    name: "Mammoth Biosciences",
    sector: "Biotech & Health",
    description: "CRISPR-based diagnostics and therapeutics platform leveraging novel CRISPR systems for detection and gene editing.",
    ...
    totalRaised: "$400M+",
    valuation: "$1B+",
    tags: ["CRISPR", "diagnostics", "gene editing"],
    signal: "rising",
    scores: { team: 9, traction: 7, techMoat: 9, market: 9, momentum: 8 },
    competitors: ["Sherlock Biosciences", "Beam Therapeutics"],
    addedDate: "2026-02"
  },
  {
    name: "eGenesis",
...
// Last updated: 2026-02-06 21:03
const COMPANY_SIGNALS = [
  { id: 1, type: "ipo", company: "SpaceX", headline: "How Elon Musk is rewriting the rules on founder power", source: "TechCrunch", time: "2h ago", impact: "high", unread: true },
  { id: 2, type: "funding", company: "Waymo", headline: "The Week's 10 Biggest Funding Rounds: Waymo Leads An AI-Driven Lineup Of Large Financings", source: "Crunchbase News", time: "3h ago", impact: "low", unread: true },
  { id: 3, type: "news", company: "Anthropic", headline: "The Only Thing Standing Between Humanity and AI Apocalypse Is ' Claude?", source: "Wired", time: "4h ago", impact: "low", unread: true },
  { id: 4, type: "news", company: "Shield AI", headline: "Shield AI, ST Engineering join forces on fine-tuning drone swarms", source: "Defense News", time: "6h ago", impact: "low", unread: true },
  { id: 5, type: "news", company: "OpenAI", headline: "The backlash over OpenAI's decision to retire GPT-4o shows how dangerous AI companions can be", source: "TechCrunch", time: "6h ago", impact: "low", unread: true },
  { id: 6, type: "ipo", company: "SpaceX", headline: "Rocket Report: SpaceX probes upper stage malfunction; Starship testing resumes", source: "Ars Technica Space", time: "9h ago", impact: "low", unread: false },
  { id: 7, type: "milestone", company: "Waymo", headline: "Waymo Hits a Rough Patch In Washington, DC", source: "Wired", time: "9h ago", impact: "low", unread: false },
  { id: 8, type: "ipo", company: "SpaceX", headline: "FAA approves Starship launches from LC-39A", source: "SpaceNews", time: "21h ago", impact: "low", unread: false },
  { id: 9, type: "milestone", company: "OpenAI", headline: "OpenAI launches new agentic coding model only minutes after Anthropic drops its own", source: "TechCrunch", time: "1d ago", impact: "low", unread: false },
  { id: 10, type: "news", company: "OpenAI", headline: "OpenAI is hoppin' mad about Anthropic's new Super Bowl TV ads", source: "Ars Technica", time: "1d ago", impact: "low", unread: false },
  { id: 11, type: "news", company: "Anthropic", headline: "Should AI chatbots have ads? Anthropic says no.", source: "Ars Technica", time: "1d ago", impact: "low", unread: false },
  { id: 12, type: "news", company: "OpenAI", headline: "Nvidia's $100 billion OpenAI deal has seemingly vanished", source: "Ars Technica", time: "2d ago", impact: "high", unread: false },
  { id: 13, type: "news", company: "OpenAI", headline: "New OpenAI tool renews fears that 'AI slop' will overwhelm scientific research", source: "Ars Technica Space", time: "1/29/2026", impact: "low", unread: false },
  ...
  { id: 15, type: "news", company: "OpenAI", headline: "OpenAI spills technical details about how its AI coding agent works", source: "Ars Technica", time: "1/26/2026", impact: "low", unread: false },
];
