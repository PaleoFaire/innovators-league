...
// Last updated: 2026-02-10 19:46
const COMPANY_SIGNALS = [
  { id: 1, type: "news", company: "OpenAI", headline: "ChatGPT will be available to 3 million military users on GenAI.mil", source: "Breaking Defense", time: "Just now", impact: "medium", unread: true },
  { id: 2, type: "ipo", company: "SpaceX", headline: "Spaceium demonstrates refueling actuator in orbit", source: "SpaceNews", time: "2h ago", impact: "low", unread: true },
  { id: 3, type: "news", company: "OpenAI", headline: "OpenAI Abandons 'io' Branding for Its AI Hardware", source: "Wired", time: "14h ago", impact: "low", unread: true },
  { id: 4, type: "ipo", company: "SpaceX", headline: "Musk says SpaceX focus is on the moon rather than Mars", source: "SpaceNews", time: "20h ago", impact: "low", unread: true },
  { id: 5, type: "ipo", company: "SpaceX", headline: "This Startup Thinks It Can Make Rocket Fuel From Water. Stop Laughing", source: "Wired", time: "1d ago", impact: "low", unread: true },
  { id: 6, type: "ipo", company: "SpaceX", headline: "Falcon 9 returns to flight after upper stage engine investigation", source: "SpaceNews", time: "2d ago", impact: "low", unread: false },
  { id: 7, type: "ipo", company: "SpaceX", headline: "SpaceX IPO could drive investor interest in other space companies", source: "SpaceNews", time: "2d ago", impact: "high", unread: false },
  { id: 8, type: "news", company: "Starlink", headline: "Moltbook, the Social Network for AI Agents, Exposed Real Humans' Data", source: "Wired", time: "3d ago", impact: "low", unread: false },
  { id: 9, type: "funding", company: "Waymo", headline: "The Week's 10 Biggest Funding Rounds: Waymo Leads An AI-Driven Lineup Of Large Financings", source: "Crunchbase News", time: "4d ago", impact: "low", unread: false },
  { id: 10, type: "news", company: "Shield AI", headline: "Shield AI, ST Engineering join forces on fine-tuning drone swarms", source: "Defense News", time: "4d ago", impact: "low", unread: false },
  { id: 11, type: "ipo", company: "SpaceX", headline: "Rocket Report: SpaceX probes upper stage malfunction; Starship testing resumes", source: "Ars Technica Space", time: "4d ago", impact: "low", unread: false },
  { id: 12, type: "news", company: "OpenAI", headline: "OpenAI is hoppin' mad about Anthropic's new Super Bowl TV ads", source: "Ars Technica", time: "5d ago", impact: "low", unread: false },
  { id: 13, type: "news", company: "Anthropic", headline: "Should AI chatbots have ads? Anthropic says no.", source: "Ars Technica", time: "5d ago", impact: "low", unread: false },
  { id: 14, type: "news", company: "OpenAI", headline: "Nvidia's $100 billion OpenAI deal has seemingly vanished", source: "Ars Technica", time: "6d ago", impact: "high", unread: false },
  { id: 15, type: "news", company: "OpenAI", headline: "New OpenAI tool renews fears that 'AI slop' will overwhelm scientific research", source: "Ars Technica Space", time: "1/29/2026", impact: "low", unread: false },
];
