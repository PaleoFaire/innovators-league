...
// Last updated: 2026-02-21 20:52
const COMPANY_SIGNALS = [
  { id: 1, type: "milestone", company: "Vast", headline: "Peak Fuel Cell Bus Deliveries in the EU Occurred in 2025", source: "CleanTechnica", time: "Just now", impact: "low", unread: true },
  { id: 2, type: "hire", company: "Photonic Inc", headline: "Microsoft's new gaming CEO vows not to flood the ecosystem with 'endless AI slop'", source: "TechCrunch", time: "3h ago", impact: "low", unread: true },
  { id: 3, type: "ipo", company: "Astro Mechanica", headline: "NASA preparing for Artemis 2 rollback to fix upper stage problem", source: "SpaceNews", time: "4h ago", impact: "low", unread: true },
  { id: 4, type: "news", company: "Labelbox", headline: "Google VP warns that two types of AI startups may not survive", source: "TechCrunch", time: "4h ago", impact: "low", unread: true },
  { id: 5, type: "news", company: "OpenAI", headline: "OpenAI debated calling police about suspected Canadian shooter's chats", source: "TechCrunch", time: "5h ago", impact: "low", unread: true },
  { id: 6, type: "news", company: "Base Power", headline: "Cultural Architects, Trojan Horses, And Another EV Startup To Challenge Tesla", source: "CleanTechnica", time: "6h ago", impact: "low", unread: false },
  { id: 7, type: "hire", company: "Commonwealth Fusion Systems", headline: "AI Data Centers Turn to High-Temperature Superconductors", source: "IEEE Spectrum", time: "6h ago", impact: "low", unread: false },
  { id: 8, type: "news", company: "Reveal Technology", headline: "Dinosaur eggshells can reveal the age of other fossils", source: "Ars Technica Space", time: "7h ago", impact: "low", unread: false },
  { id: 9, type: "news", company: "Palantir", headline: "Major government research lab appears to be squeezing out foreign scientists", source: "Ars Technica Space", time: "9h ago", impact: "low", unread: false },
  { id: 10, type: "news", company: "Galvanick", headline: "Password Managers Share a Hidden Weakness", source: "Wired", time: "9h ago", impact: "low", unread: false },
  { id: 11, type: "news", company: "Photonic Inc", headline: "You Can Now Install'and Update'Microsoft Store Apps Using the Command Line", source: "Wired", time: "9h ago", impact: "low", unread: false },
  { id: 12, type: "news", company: "Xcimer Energy", headline: "iRestore Elite Laser Hair Growth System Review: Surprisingly Effective", source: "Wired", time: "10h ago", impact: "low", unread: false },
  { id: 13, type: "hire", company: "Figure AI", headline: "After the 2026 Winter Olympics, Figure Skating Will Never Be the Same", source: "Wired", time: "10h ago", impact: "low", unread: false },
  { id: 14, type: "news", company: "Arc Boats", headline: "'Narco-Submarine' Carrying 4 Tons of Cocaine Captured by Mexico's Navy", source: "Wired", time: "10h ago", impact: "low", unread: false },
  { id: 15, type: "ipo", company: "DIRAC", headline: "How Can IAA Bring Local Cleantech Manufacturing?", source: "CleanTechnica", time: "15h ago", impact: "low", unread: false },
];
