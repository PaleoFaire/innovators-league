...
const COMPANIES = [
  ...
  },
  {
    name: "General Matter",
    sector: "Nuclear Energy",
    description: "Tackling unsolved problems in nuclear energy, working on next-generation nuclear fuel and reactor technology.",
    thesis: "Addressing the hard remaining challenges in nuclear power that legacy players have avoided.",
    location: "Boston, MA",
    state: "Massachusetts",
    lat: 42.3601,
    lng: -71.0589,
    ...
    totalRaised: "$10M+",
    valuation: "",
    tags: ["nuclear", "energy", "deep tech"],
    signal: "rising",
    scores: { team: 8, traction: 5, techMoat: 8, market: 9, momentum: 7 },
    competitors: ["Oklo", "Kairos Power"],
    addedDate: "2026-02"
  },
  {
    name: "Standard Nuclear",
    sector: "Nuclear Energy",
    description: "Working on solving the remaining hard problems in nuclear energy deployment and operations.",
    thesis: "Making nuclear power practical and deployable at scale by tackling the unsexy but critical challenges.",
    location: "San Francisco, CA",
    state: "California",
    lat: 37.7749,
    lng: -122.4194,
    ...
    totalRaised: "$8M+",
    valuation: "",
    tags: ["nuclear", "energy", "infrastructure"],
    signal: "stable",
    scores: { team: 7, traction: 5, techMoat: 7, market: 9, momentum: 6 },
    competitors: ["Oklo", "Kairos Power"],
    addedDate: "2026-02"
  ...
  },
  {
    name: "Nucleus Genomics",
    sector: "Biotech",
    description: "Embryo selection and genetic screening technology for healthier outcomes using advanced genomics.",
    thesis: "Giving parents the tools to give their children the best possible genetic start in life.",
    location: "San Francisco, CA",
    state: "California",
    lat: 37.7749,
    lng: -122.4194,
    ...
    totalRaised: "$25M+",
    valuation: "",
    tags: ["genomics", "embryo selection", "biotech", "fertility"],
    signal: "rising",
    scores: { team: 8, traction: 6, techMoat: 8, market: 8, momentum: 7 },
    competitors: ["Orchid", "23andMe"],
    addedDate: "2026-02"
  },
  {
    name: "Orchid",
    sector: "Biotech",
    description: "Whole genome sequencing for embryos to screen for genetic diseases and optimize health outcomes.",
    thesis: "Using genomics to reduce disease risk and improve human health from the very beginning.",
    location: "San Francisco, CA",
    state: "California",
    lat: 37.7800,
    lng: -122.4100,
    ...
    totalRaised: "$12M+",
    valuation: "",
    tags: ["genomics", "embryo screening", "biotech", "fertility"],
    signal: "stable",
    scores: { team: 8, traction: 6, techMoat: 8, market: 8, momentum: 7 },
    competitors: ["Nucleus Genomics", "Genomic Prediction"],
    addedDate: "2026-02"
  }
];
...
// Last updated: 2026-02-08 20:57
const COMPANY_SIGNALS = [
  { id: 1, type: "news", company: "OpenAI", headline: "From Svedka to Anthropic, brands make bold plays with AI in Super Bowl ads", source: "TechCrunch", time: "4h ago", impact: "low", unread: true },
  { id: 2, type: "ipo", company: "SpaceX", headline: "Falcon 9 returns to flight after upper stage engine investigation", source: "SpaceNews", time: "22h ago", impact: "low", unread: true },
  { id: 3, type: "ipo", company: "SpaceX", headline: "SpaceX IPO could drive investor interest in other space companies", source: "SpaceNews", time: "1d ago", impact: "high", unread: true },
  { id: 4, type: "news", company: "Starlink", headline: "Moltbook, the Social Network for AI Agents, Exposed Real Humans' Data", source: "Wired", time: "1d ago", impact: "low", unread: true },
  { id: 5, type: "funding", company: "Cerebras", headline: "Benchmark raises $225M in special funds to double down on Cerebras", source: "TechCrunch", time: "1d ago", impact: "medium", unread: true },
  { id: 6, type: "ipo", company: "SpaceX", headline: "How Elon Musk is rewriting the rules on founder power", source: "TechCrunch", time: "2d ago", impact: "high", unread: false },
  { id: 7, type: "funding", company: "Waymo", headline: "The Week's 10 Biggest Funding Rounds: Waymo Leads An AI-Driven Lineup Of Large Financings", source: "Crunchbase News", time: "2d ago", impact: "low", unread: false },
  { id: 8, type: "news", company: "Anthropic", headline: "The Only Thing Standing Between Humanity and AI Apocalypse Is ' Claude?", source: "Wired", time: "2d ago", impact: "low", unread: false },
  { id: 9, type: "news", company: "Shield AI", headline: "Shield AI, ST Engineering join forces on fine-tuning drone swarms", source: "Defense News", time: "2d ago", impact: "low", unread: false },
  ...
  { id: 13, type: "news", company: "OpenAI", headline: "OpenAI is hoppin' mad about Anthropic's new Super Bowl TV ads", source: "Ars Technica", time: "3d ago", impact: "low", unread: false },
