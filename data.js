...
const COMPANIES = [
  // ─── DEFENSE & SECURITY ───
  {
    ...
    thesis: {
      bull: "Lattice OS becomes the operating system for all autonomous defense platforms. First-mover advantage in AI-enabled military hardware with software margins. $28B+ backlog creates multi-decade revenue visibility.",
  ...
  },
  {
    name: "Saronic",
    sector: "Defense & Security",
    description: "Autonomous surface vessels built at shipyard scale. Vertically integrated 'shipyard as startup' producing autonomous boats for naval defense on rapid cycles. $4B valuation, $830M+ raised.",
    founder: "",
    location: "Austin, TX",
    state: "TX",
    lat: 30.2672,
    ...
    competitors: [],
    recentEvent: { type: "funding", text: "Raised $830M+ at $4B valuation for autonomous naval vessel production", date: "2026-01" },
    addedDate: "2024-06"
  },
  {
    name: "Neros",
  ...
  // ─── AI & SOFTWARE (new) ───
  {
    ...
    thesis: {
      bull: "Dominant position in foundation models with GPT series. Enterprise revenue growing rapidly. Platform ecosystem creates switching costs.",
...
const DEAL_TRACKER = [
  { company: "Saronic", investor: "a16z", amount: "$830M+", round: "Series C", date: "2026-01", valuation: "$4B", leadOrParticipant: "lead" },
  { company: "Saronic", investor: "8VC", amount: "$830M+", round: "Series C", date: "2026-01", valuation: "$4B", leadOrParticipant: "participant" },
  ...
  { company: "Shield AI", investor: "a16z", amount: "$1.4B", round: "Series F", date: "2025-07", valuation: "$5.3B", leadOrParticipant: "lead" },
  { company: "Shield AI", investor: "Sequoia Capital", amount: "$1.4B", round: "Series F", date: "2025-07", valuation: "$5.3B", leadOrParticipant: "participant" },
  { company: "Physical Intelligence", investor: "Khosla Ventures", amount: "$400M", round: "Series A", date: "2025-11", valuation: "$2.4B", leadOrParticipant: "lead" },
  { company: "Physical Intelligence", investor: "Sequoia Capital", amount: "$400M", round: "Series A", date: "2025-11", valuation: "$2.4B", leadOrParticipant: "lead" },
  { company: "Physical Intelligence", investor: "Lux Capital", amount: "$400M", round: "Series A", date: "2025-11", valuation: "$2.4B", leadOrParticipant: "participant" },
  { company: "Epirus", investor: "8VC", amount: "$550M+", round: "Late Stage", date: "2026-01", valuation: "$1.35B", leadOrParticipant: "participant" },
  { company: "Hadrian", investor: "a16z", amount: "$217M", round: "Series C", date: "2025-08", valuation: "$1.7B", leadOrParticipant: "lead" },
  { company: "Hadrian", investor: "Eclipse Ventures", amount: "$217M", round: "Series C", date: "2025-08", valuation: "$1.7B", leadOrParticipant: "participant" },
  { company: "Boom Supersonic", investor: "Founders Fund", amount: "$250M+", round: "Series C", date: "2025-09", valuation: "$8B+", leadOrParticipant: "participant" },
  { company: "Helion", investor: "Sam Altman", amount: "$500M+", round: "Series E", date: "2025-05", valuation: "$6B+", leadOrParticipant: "lead" },
  { company: "Skild AI", investor: "a16z", amount: "$300M", round: "Series A", date: "2025-06", valuation: "$1.5B", leadOrParticipant: "participant" },
