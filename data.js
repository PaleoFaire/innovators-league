...
const COMPANY_SIGNALS = [
  { id: 1, type: "news", company: "Chaos Industries", headline: "All eyes on Air Force leaders after a year of chaos and change", source: "Defense One", time: "Just now", impact: "low", unread: true },
  { id: 2, type: "ipo", company: "Rocket Lab", headline: "German defense firm said to be weighing bid for Mynaric", source: "SpaceNews", time: "2h ago", impact: "high", unread: true },
  { id: 3, type: "news", company: "Turbopuffer", headline: "How to Hide Google's AI Overviews From Your Search Results", source: "Wired", time: "2h ago", impact: "low", unread: true },
  { id: 4, type: "news", company: "Earth AI", headline: "How to View the 'Blood Moon' Total Lunar Eclipse on March 3", source: "Wired", time: "3h ago", impact: "low", unread: true },
  { id: 5, type: "hire", company: "Attio", headline: "Tesla Sales Declined 11.4% in California in 2025", source: "CleanTechnica", time: "8h ago", impact: "low", unread: true },
  { id: 6, type: "ipo", company: "DIRAC", headline: "Grey, Blue, or Green: The Real Ammonia Math", source: "CleanTechnica", time: "12h ago", impact: "low", unread: false },
  { id: 7, type: "news", company: "Cape", headline: "Hegseth's Blacklists Target Academia &#038; Cleantech, Not National Security Threats", source: "CleanTechnica", time: "16h ago", impact: "low", unread: false },
  { id: 8, type: "milestone", company: "Vast", headline: "Peak Fuel Cell Bus Deliveries in the EU Occurred in 2025", source: "CleanTechnica", time: "17h ago", impact: "low", unread: false },
  { id: 9, type: "hire", company: "Photonic Inc", headline: "Microsoft's new gaming CEO vows not to flood the ecosystem with 'endless AI slop'", source: "TechCrunch", time: "20h ago", impact: "low", unread: false },
  { id: 10, type: "ipo", company: "Astro Mechanica", headline: "NASA preparing for Artemis 2 rollback to fix upper stage problem", source: "SpaceNews", time: "21h ago", impact: "low", unread: false },
  { id: 11, type: "news", company: "Labelbox", headline: "Google VP warns that two types of AI startups may not survive", source: "TechCrunch", time: "21h ago", impact: "low", unread: false },
  { id: 12, type: "news", company: "OpenAI", headline: "OpenAI debated calling police about suspected Canadian shooter's chats", source: "TechCrunch", time: "22h ago", impact: "low", unread: false },
  { id: 13, type: "news", company: "Base Power", headline: "Cultural Architects, Trojan Horses, And Another EV Startup To Challenge Tesla", source: "CleanTechnica", time: "23h ago", impact: "low", unread: false },
  { id: 14, type: "hire", company: "Commonwealth Fusion Systems", headline: "AI Data Centers Turn to High-Temperature Superconductors", source: "IEEE Spectrum", time: "23h ago", impact: "low", unread: false },
  { id: 15, type: "news", company: "Reveal Technology", headline: "Dinosaur eggshells can reveal the age of other fossils", source: "Ars Technica Space", time: "1d ago", impact: "low", unread: false },
];
